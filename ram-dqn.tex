...
\section{Games}
We test our models on three games: \optional{test on space invaders or something? it shouldn't take much time.}
...
The process of evaluating the RAM version of DQN is divided in experiments. By one experiment we mean a full training of a single deep Q-network in a fixed game. The training consists of $100$ epochs, each containing a training and testing part.\optional{do we have eval results of 200 epochs?}.
